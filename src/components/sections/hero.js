        ...
        <div className="hero-left-container">
          ...
          <div className="hero-text-container">
            <div className="hero-title">
              <h1>
                {CONFIG.hero[0].first_line}&nbsp;
              </h1>
              <h1 className="primary-color">
                {CONFIG.hero[0].main_line}
              </h1>
            </div>
            <div className="hero-buttons">
              <button
                ...
                onClick={() =>
                  handleButtonClick(CONFIG.hero[0].primary_button_url)}
              >
                <span>
                  {CONFIG.hero[0].primary_button}
                </span>
              ...
              >
                <span>
                  {CONFIG.hero[0].secondary_button}
                </span>
